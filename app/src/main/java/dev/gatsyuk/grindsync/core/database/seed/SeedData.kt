package dev.gatsyuk.grindsync.core.database.seed

import dev.gatsyuk.grindsync.core.model.ContributionWeights.PRIMARY
import dev.gatsyuk.grindsync.core.model.ContributionWeights.SECONDARY
import dev.gatsyuk.grindsync.core.model.ExerciseType
import dev.gatsyuk.grindsync.core.model.ExerciseType.ASSISTED_WEIGHT_REPS
import dev.gatsyuk.grindsync.core.model.ExerciseType.BODYWEIGHT_REPS
import dev.gatsyuk.grindsync.core.model.ExerciseType.BODYWEIGHT_TIME
import dev.gatsyuk.grindsync.core.model.ExerciseType.BODYWEIGHT_WEIGHT_REPS
import dev.gatsyuk.grindsync.core.model.ExerciseType.CARDIO_TIME_DISTANCE_KCAL
import dev.gatsyuk.grindsync.core.model.ExerciseType.OTHER_NOTES
import dev.gatsyuk.grindsync.core.model.ExerciseType.STRENGTH_WEIGHT_DISTANCE
import dev.gatsyuk.grindsync.core.model.ExerciseType.STRENGTH_WEIGHT_DISTANCE_TIME
import dev.gatsyuk.grindsync.core.model.ExerciseType.STRENGTH_WEIGHT_REPS
import dev.gatsyuk.grindsync.core.model.ExerciseType.STRENGTH_WEIGHT_TIME
import dev.gatsyuk.grindsync.core.model.Muscle
import dev.gatsyuk.grindsync.core.model.Muscle.ABS
import dev.gatsyuk.grindsync.core.model.Muscle.ADDUCTORS
import dev.gatsyuk.grindsync.core.model.Muscle.BICEPS
import dev.gatsyuk.grindsync.core.model.Muscle.CALVES
import dev.gatsyuk.grindsync.core.model.Muscle.CHEST
import dev.gatsyuk.grindsync.core.model.Muscle.FOREARMS
import dev.gatsyuk.grindsync.core.model.Muscle.FRONT_DELTS
import dev.gatsyuk.grindsync.core.model.Muscle.GLUTES
import dev.gatsyuk.grindsync.core.model.Muscle.HAMSTRINGS
import dev.gatsyuk.grindsync.core.model.Muscle.LATS
import dev.gatsyuk.grindsync.core.model.Muscle.LOWER_BACK
import dev.gatsyuk.grindsync.core.model.Muscle.OBLIQUES
import dev.gatsyuk.grindsync.core.model.Muscle.QUADS
import dev.gatsyuk.grindsync.core.model.Muscle.REAR_DELTS
import dev.gatsyuk.grindsync.core.model.Muscle.SIDE_DELTS
import dev.gatsyuk.grindsync.core.model.Muscle.TRAPS
import dev.gatsyuk.grindsync.core.model.Muscle.TRICEPS
import dev.gatsyuk.grindsync.core.model.Muscle.UPPER_BACK
...
object SeedData {
    ...
    fun contributionWeight(role: dev.gatsyuk.grindsync.core.model.MuscleRole): Double =
        when (role) {
            dev.gatsyuk.grindsync.core.model.MuscleRole.PRIMARY -> PRIMARY
            dev.gatsyuk.grindsync.core.model.MuscleRole.SECONDARY -> SECONDARY
        }
}
